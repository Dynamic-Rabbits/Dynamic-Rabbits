...
#ifndef DATASTRUCTS_MAPS_UB_INTPTR_HASHMAP_H_
#define DATASTRUCTS_MAPS_UB_INTPTR_HASHMAP_H_
 ...
 *  @param detroy_val_func Function called to destroy a value
 */
DR_EXPORT void ub_intptr_hashmap_destroy_map(void *map_opaque, ub_destroy_value_func_t detroy_val_func);
 ...
 */
DR_EXPORT void ub_intptr_hashmap_apply_all_values(void *map, void (*apply_func)(void *value));
 ...
 */
DR_EXPORT void* ub_intptr_hashmap_insert_entry(void *map, ub_key_value_pair_t *key_val_pair);
...
#endif /* DATASTRUCTS_MAPS_UB_INTPTR_HASHMAP_H_ */

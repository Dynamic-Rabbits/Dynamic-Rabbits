...
void got_cl_data(ub_ev_cl_arg_data_t *data) {
	...
	DR_ASSERT_MSG(data->index == 1,
			"ub_cl_arg_input_option_test3 - 0 failed...");

    DR_ASSERT_MSG(strcmp(data->arg, "Test") == 0,
			"ub_cl_arg_input_option_tes3 - 1 failed...");
}

static void event_exit() {

	DR_ASSERT_MSG(count == 1,
			"ub_cl_arg_input_option_test3 - 2 failed...");

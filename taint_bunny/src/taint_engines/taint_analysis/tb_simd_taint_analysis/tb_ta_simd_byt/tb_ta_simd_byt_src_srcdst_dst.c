/*
 * tb_ta_simd_byt_src_srcdst_dst.c
 *
 *      Author: john
 */

#include "tb_ta_simd_byt_src_srcdst_dst.h"
...
static void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_propagate(
    ...
    tb_simd_meet_from_1_src(instr_hndlr_info->tb_ctx, 0, size, drcontext, ilist,
            ...
            src_reg_id1, spill_info->xmm_regs[0],spill_info->xmm_regs[0], spill_info->scaler_regs[3]);

    reg_id_t meet_reg2 = src_reg_id1;
    tb_simd_meet_from_1_src(instr_hndlr_info->tb_ctx, 0, size, drcontext, ilist,
            where, tb_raw_get_app_pc(app_instr), false, meet_reg2, srcdst_reg_id2,
    ...
    tb_simd_apply_to_2_reg_from_2_src(instr_hndlr_info, drcontext, ilist, where,
            ...
            srcdst_reg_id2, 0, size, spill_info->xmm_regs[0],
...
static void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_dreg_sreg_sreg(
        tb_raw_instr_hndlr_info_t *instr_hndlr_info, size_t size,
    ...
    tb_simd_byt_handle_src_srcdst_dst_whole_dreg_propagate(instr_hndlr_info,
            size, drcontext, ilist, where, app_instr, false, dst_reg_id1,
            srcdst_reg_id2, src_reg_id1, spill_info);
}

static void tb_simd_handle_src_srcdst_dst_whole_dreg_dreg_smem_sreg(
        tb_raw_instr_hndlr_info_t *instr_hndlr_info, size_t size,
        void *drcontext, instrlist_t *ilist, instr_t *where, instr_t *app_instr,
    ...
    tb_simd_byt_handle_src_srcdst_dst_whole_dreg_propagate(instr_hndlr_info,
            size, drcontext, ilist, where, app_instr, true, dst_reg_id1,
            srcdst_reg_id2, src_mem_id, spill_info);
}
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_1_dreg_1_sreg_1_sreg_1(
    ...
    /** DON'T USE SIMD **/
    tb_raw_byt_handle_src_srcdst_dst_whole_dreg_1_dreg_1_sreg_1_sreg_1(
            instr_hndlr_info, drcontext, ilist, where, app_instr, dst_reg_id1,
            srcdst_reg_id2, src_reg_id1, spill_info);
}
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_2_dreg_2_sreg_2_sreg_2(
    ...
    /** DON'T USE SIMD **/
    tb_raw_byt_handle_src_srcdst_dst_whole_dreg_2_dreg_2_sreg_2_sreg_2(
            instr_hndlr_info, drcontext, ilist, where, app_instr, dst_reg_id1,
            srcdst_reg_id2, src_reg_id1, spill_info);
}
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_4_dreg_4_sreg_4_sreg_4(
    ...
    tb_simd_byt_handle_src_srcdst_dst_whole_dreg_dreg_sreg_sreg(
            instr_hndlr_info, 4, drcontext, ilist, where, app_instr,
            dst_reg_id1, srcdst_reg_id2, src_reg_id1, spill_info);
}
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_1_dreg_1_smem_1_sreg_1(
    ...
    /** DON'T USE SIMD **/
    tb_raw_byt_handle_src_srcdst_dst_whole_dreg_1_dreg_1_smem_1_sreg_1(
            instr_hndlr_info, drcontext, ilist, where, app_instr, dst_reg_id1,
            srcdst_reg_id2, src_mem_id, spill_info);
}
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_2_dreg_2_smem_2_sreg_2(
    ...
    /** DON'T USE SIMD **/
    tb_raw_byt_handle_src_srcdst_dst_whole_dreg_2_dreg_2_smem_2_sreg_2(
            instr_hndlr_info, drcontext, ilist, where, app_instr, dst_reg_id1,
            srcdst_reg_id2, src_mem_id, spill_info);
}
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_4_dreg_4_smem_4_sreg_4(
    ...
    tb_simd_handle_src_srcdst_dst_whole_dreg_dreg_smem_sreg(instr_hndlr_info, 4,
...
void tb_simd_byt_handle_src_srcdst_dst_whole_dreg_8_dreg_8_smem_8_sreg_8(
    ...
    tb_simd_handle_src_srcdst_dst_whole_dreg_dreg_smem_sreg(instr_hndlr_info, 8,
            drcontext, ilist, where, app_instr, dst_reg_id1, srcdst_reg_id2,
            src_mem_id, spill_info);
}

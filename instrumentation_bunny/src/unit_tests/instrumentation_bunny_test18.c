...
static void event_exit() {
    ...
    DR_ASSERT_MSG(clean_called_2 == true,
            "ub_code_cache_test - test4 failed...");
    DR_ASSERT_MSG(clean_called_3 == false,
            "ub_code_cache_test - test4 failed...");
...
DR_EXPORT void dr_client_main(client_id_t id, int argc, const char *argv[]) {
    ...
    cc_data2.user_data = (void *) 4;
    cc_data2.user_instrum_func = ib_target_insert_hndle_func_test;
    ...
    ib_hook_cache_to_branch_instr(instrum_tool, OP_jg, &cc_data1, &cc_data2,
    NULL, IB_OPT_REG_OPND_INFO | IB_OPT_ADDR_OPND_INFO | IB_OPT_OPCODE_INFO | IB_OPT_OPND_COUNT_INFO | IB_OPT_PC_INFO

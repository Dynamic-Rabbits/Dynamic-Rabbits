...
static void *pre_analyse_bb(void *drcontext, instrlist_t *bb, void *user_data) {

	DR_ASSERT(user_data == (void * ) 888);

	int *u = dr_global_alloc(sizeof(int));
	*u = 82;
	return (void *) u;
}

static void destroy_pre_analysis(void *drcontext, void *user_data,
		void *pre_analysis_data) {

	int *my_int = (int *) pre_analysis_data;
	DR_ASSERT(user_data == (void * ) 888);
	DR_ASSERT(*my_int == 82);

	dr_global_free(my_int, sizeof(int));
}
...
static void ib_restore_regs_func_test(void *drcontext, instrlist_t *ilist,
		instr_t *where, void *user_data, void *spill_user_data) {
...
static void ib_clean_call(app_pc value) {
...
static void ib_code_cache_insert_hndle_func_test(void *drcontext,
		instrlist_t *bb, instr_t *where, instr_t *app, void *user_data,
		void *spill_data) {
...
static void ib_clean_call_comparator(reg_id_t reg) {
...
static void get_comparator(void *drcontext, instrlist_t *bb, instr_t *where,
	...
	dr_insert_clean_call(drcontext, bb, where, ib_clean_call_comparator,
	false, 0);
}
...
DR_EXPORT void dr_client_main(client_id_t id, int argc, const char *argv[]) {
	...
	ib_dup_opts_t dup_opts =
			{ create_default_manager, pre_analyse_bb, destroy_pre_analysis,
					analyse_bb, get_comparator, NULL, NULL, (void *) 888 };

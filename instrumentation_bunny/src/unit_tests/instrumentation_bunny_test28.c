...
DR_EXPORT void dr_client_main(client_id_t id, int argc, const char *argv[]) {
    ...
    in_data.user_data = (void *) 8;
    in_data.user_instrum_func = ib_code_cache_insert_hndle_func_test;
    in_data.restore_reg_func = NULL;
    in_data.spill_reg_func = NULL;
    in_data.spilling_user_data = NULL;

    ib_hook_to_instr(instrum_tool, OP_lea, &in_data,
            IB_OPT_REG_OPND_INFO | IB_OPT_ADDR_OPND_INFO | IB_OPT_OPCODE_INFO | IB_OPT_OPND_COUNT_INFO | IB_OPT_LOC_TYPE_INFO

...
DR_EXPORT void dr_client_main(client_id_t id, int argc, const char *argv[]) {
    ...
    cc_data.user_instrum_func = ib_code_cache_insert_hndle_func_test2;
    ...
    ib_hook_cache_to_instr(instrum_tool, OP_add, &cc_data,
    ...
    cc_data2.user_data = (void *) 10;
    cc_data2.user_instrum_func = ib_code_cache_insert_hndle_func_test;
    ...
    ib_hook_cache_to_instr(instrum_tool, OP_mov_st, &cc_data2,
            IB_OPT_ADDR_OPND_INFO | IB_OPT_REG_OPND_INFO | IB_OPT_OPCODE_INFO | IB_OPT_OPND_COUNT_INFO | IB_OPT_FULL_OPND_INFO);
